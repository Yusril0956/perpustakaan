            ...
            <div class="grid grid-cols-12 gap-4">
                ...
                <div class="col-span-3 sm:col-span-2">
                    <div class="relative rounded overflow-hidden"
                        style="aspect-ratio: 3/4; background: linear-gradient(135deg, #F6F2EA 0%, #FBF8F3 100%);">
                        <img src="{{ $loan->book->cover_url }}" alt="{{ $loan->book->title }}"
                            class="w-full h-full object-cover" style="filter: sepia(0.1) brightness(1.02);">
                        <!-- Gloss Effect -->
                ...
                <div class="col-span-9 sm:col-span-10 flex flex-col justify-between">
                    ...
                    <div class="mt-3 p-3 rounded"
                        style="background: linear-gradient(135deg, #FBF8F3 0%, #F9F5F0 100%); border: 1px dashed #8B7D73;">
                        ...
                        <div class="mt-2 pt-2 border-t border-muted/30 flex items-center justify-between">
                            ...
                            @if ($isOverdue)
                                <span class="text-xs font-semibold text-red-600">⚠️ Terlambat {{ abs($daysRemaining) }}
                                    hari</span>
                            @else
