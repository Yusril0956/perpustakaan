            ...
            <form wire:submit="save" x-data="{ uploading: false, progress: 0 }"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-12">
                    ...
                    <div class="space-y-10">
                        ...
                        <x-forms.input label="02. Nama Penulis / Pengarang" wire:model="form.author"
                            placeholder="..." />
                    ...
                    <div class="space-y-10">
                        <div>
                            ...
                            <select wire:model="form.category_id"
                                class="w-full bg-transparent border-0 border-b-2 border-ink/30 focus:border-ink focus:ring-0 px-0 py-2 font-serif text-xl italic text-ink cursor-pointer">
