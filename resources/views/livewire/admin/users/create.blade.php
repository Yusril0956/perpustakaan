<div class="w-full max-w-4xl mx-auto py-12 px-4">
    {{-- Navigasi --}}
    <div class="mb-8">
        <a href="{{ route('admin.users.index') }}" wire:navigate class="text-xs font-mono uppercase tracking-widest text-ink font-bold flex items-center gap-2 group">
            ...
            <form wire:submit="save" class="space-y-12">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-12">
                    ...
                    <div class="space-y-10">
                        <x-input label="01. Nama Lengkap Sesuai Identitas" wire:model="form.name" placeholder="Masukkan nama..." />
                        
                        <x-input label="02. Alamat Surat Elektronik (Email)" wire:model="form.email" type="email" placeholder="example@mail.com" />
                        
                        <x-input label="03. Password (abaikan jika tidak diubah)" wire:model="form.password" type="password" placeholder="••••••••" />
                    </div>
                    ...
                    <div class="space-y-10">
                        <div>
                            ...
                            <select wire:model="form.role" class="w-full bg-transparent border-0 border-b-2 border-ink/30 focus:border-ink focus:outline focus:ring-0 px-0 py-2 font-serif text-xl italic text-ink cursor-pointer">
                            ...
                            @error('form.role') <span class="text-[10px] font-mono uppercase font-bold text-red-700 mt-1 block">{{ $message }}</span> @enderror
                        </div>
                        ...
                        <div>
                            ...
                            @error('form.address') <span class="text-[10px] font-mono uppercase font-bold text-red-700 mt-1 block">{{ $message }}</span> @enderror
                        </div>
                    </div>
                </div>
