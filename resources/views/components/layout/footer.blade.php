        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div class="col-span-1 md:col-span-1">
                ...
                <p class="text-sm text-coffee/80 leading-relaxed italic">
                    "Menyimpan jejak pemikiran dalam lembaran digital. Kami merawat setiap kata agar tetap hidup
                    melintasi zaman."
                </p>
                <div
            ...
            <div>
                ...
                <div class="text-sm italic text-coffee space-y-4">
                    <p class="flex items-start gap-3">
                        ...
                        <span>Jl. Perpustakaan Lama No. 12, Kota Arsip</span>
                    </p>
                    <p class="flex items-center gap-3">
                        <x-heroicon-o-envelope class="w-5 h-5 text-sepia-edge" />
                        <span>surat@pustakaklasik.com</span>
                    </p>
                    <p class="flex items-center gap-3">
